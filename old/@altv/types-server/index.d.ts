...
declare module "alt-server" {
  ...
  export class Accounts {
    ...
    public adminLevel2: [number, number];
    public ban: number;
    public password: string;
    public logins: number;
    public aduty: boolean;
    ...
    public supportNumber: number;
    /**
     * Array 0 = character0 ; Array 1 = character2
     */
  ...
  export class Character {
    ...
    public clothes: {};
    /**
     * Everything that has to do with death
     */
    public dead: {
      deadTimeout: number;
      /**
