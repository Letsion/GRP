        ...
        function (a, b, c) {
          ...
          b.exports = function (a, b, c) {
            function f(b, f) {
              ...
              b.line && (o(b, 0, ""), o(b, 1, "line"), o(b, 2, ""), (h += "on line " + b.line + ", column " + (b.column + 1) + ":</p><ul>" + l.join("") + "</ul>")),
                b.stack && (b.extract || c.logLevel >= 4) && (h += "<br/>Stack Trace</br />" + b.stack.split("\n").slice(1).join("<br/>")),
                (k.innerHTML = h),
                e.createCSS(a.document, [".less-error-message ul, .less-error-message li {", "list-style-type: none;", "margin-right: 15px;", "padding: 4px 0;", "margin: 0;", "}", ".less-error-message label {", "font-size: 12px;", "margin-right: 15px;", "padding: 4px 0;", "color: #cc7777;", "}", ".less-error-message pre {", "color: #dd6666;", "padding: 4px 0;", "margin: 0;", "display: inline-block;", "}", ".less-error-message pre.line {", "color: #ff0000;", "}", ".less-error-message h3 {", "font-size: 20px;", "font-weight: bold;", "padding: 15px 0 5px 0;", "margin: 0;", "}", ".less-error-message a {", "color: #10a", "}", ".less-error-message .error {", "color: red;", "font-weight: bold;", "padding-bottom: 2px;", "border-bottom: 1px dashed red;", "}"].join("\n"), { title: "error-message" }),
                        ...
                        : j(
                            function (a, c, h, j, n) {
                              return a
                                ...
                                : (m.logger.info(n.local ? "Loading " + j.href + " from cache." : "Rendered " + j.href + " successfully."),
              ...
              return {
                ...
                parse: function (g, h, j) {
                  ...
                  if (!v.isFinished) {
                    ...
                    w || ((w = "Unrecognised input"), "}" === v.furthestChar ? (w += ". Possibly missing opening '{'") : ")" === v.furthestChar ? (w += ". Possibly missing opening '('") : v.furthestReachedEnd && (w += ". Possibly missing something")),
                      (p = new d(
                        {
                          type: "Parse",
                          message: w,
        ...
        function (a, b, c) {
          ...
          (j.prototype = new e()),
            ...
            (j.prototype.eval = function (a) {
              ...
              try {
                if ((a.importantScope.push({}), (c = this.value.eval(a)), !this.variable && "DetachedRuleset" === c.type))
                  throw {
            ...
            (i.prototype.eval = function (a) {
              ...
              return (
                ...
                this.value.length > 1
                  ...
                  : 1 === this.value.length
                  ? (!this.value[0].parens || this.value[0].parensInOp || a.inCalc || (f = !0), (b = this.value[0].eval(a)))
                  : (b = this),
          ...
          (h.prototype = new d()),
            ...
            (h.prototype.eval = function (a) {
              ...
              for (this.selector = this.selector.eval(a), j = 0; j < this.arguments.length; j++)
                if (((h = this.arguments[j]), (i = h.value.eval(a)), h.expand && Array.isArray(i.value))) for (i = i.value, k = 0; k < i.length; k++) t.push({ value: i[k] });
            ...
            (h.prototype.eval = function (a) {
              ...
              for (b = 0; b < this.lookups.length; b++) {
                if (((c = this.lookups[b]), Array.isArray(d) && (d = new f([new g()], d)), "" === c)) d = d.lastDeclaration();
                  ...
                  if (("@" === c.charAt(1) && (c = "@" + new e(c.substr(1)).eval(a).value), d.variables && (d = d.variable(c)), !d))
                    throw {
                      type: "Name",
                  ...
                  if (((c = "$@" === c.substring(0, 2) ? "$" + new e(c.substr(1)).eval(a).value : "$" === c.charAt(0) ? c : "$" + c), d.properties && (d = d.property(c)), !d))
                    throw {
                      type: "Name",
              ...
              function b(a) {
                return a.value instanceof k && !a.parsed
                  ? ("string" == typeof a.value.value
                      ? this.parse.parseNode(a.value.value, ["value", "important"], a.value.getIndex(), a.fileInfo(), function (b, c) {
        ...
        function (a, b, c) {
          ...
          (f.prototype = new d()),
            ...
            (f.prototype.eval = function (a) {
              var b,
                c = this.name;
              if ((0 === c.indexOf("@@") && (c = "@" + new f(c.slice(1), this.getIndex(), this.fileInfo()).eval(a).value), this.evaluating))
                throw {
                  type: "Name",
          ...
          var d = a("./constants"),
            ...
            f = {
              ...
              copyOptions: function (a, b) {
                ...
                if ((c.strictMath && (c.math = d.Math.STRICT_LEGACY), c.relativeUrls && (c.rewriteUrls = d.RewriteUrls.ALL), "string" == typeof c.math))
        ...
        function (a, b, c) {
          ...
          (i.prototype = {
            ...
            extendSelector: function (a, b, c, e) {
              ...
              return (
                k < b.length && l > 0 && ((m[m.length - 1].elements = m[m.length - 1].elements.concat(b[k].elements.slice(l))), k++),
          ...
          (i.prototype = {
            ...
            flatten: function (a, b) {
              ...
              for (d = 0, c = a.length; d < c; d++)
                if (((e = a[d]), void 0 !== e))
                  if (e.splice) for (g = 0, f = e.length; g < f; g++) (h = e[g]), void 0 !== h && (h.splice ? h.length && this.flatten(h, b) : b.push(h));
                  else b.push(e);
              return b;
            },
          }),
