(() => {
  ...
  const styles = `
        ...
        .vt-card {
            ...
            box-shadow: 0 4px 12px rgb(82, 82, 83);
            color: #ffffff;
            border-radius: 4px;
            margin: 0px;
  ...
  function destroy(vtCard) {
    ...
    setTimeout((vt = vtCard) => {
      vt.parentNode.removeChild(vt);
      if (typeof vt.options.callback === "function") {
        vt.options.callback();
      }
    }, 500);
  }
